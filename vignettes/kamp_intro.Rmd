...
- `marksvar1`: The name of the marks variable for the first mark (required for univariate).

- `marksvar2`: The name of the marks variable for the second mark (optional for univariate).
