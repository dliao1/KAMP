---
title: "Introduction to kperm"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to kperm}
...
# Introduction
Hello and welcome to the `kperm` package! 
...
The `kperm` package provides functions to simulate point patterns, calculate the KAMP CSR, and visualize the results. The package is designed to be user-friendly and easy to use, with a focus on providing clear and concise output.
...
- `cell_type1`: The name of the first cell type. Defaults to "immune".

- `cell_type2`: The name of the second cell type. Defaults to "background".
...
- `cell_type3`: The name of the third cell type. Defaults to "background".
